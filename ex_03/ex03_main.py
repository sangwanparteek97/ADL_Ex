...
class JEM(pl.LightningModule):
    def __init__(self, img_shape, batch_size, num_classes=42, cbuffer_size=256, ccond_sample=False, alpha=0.1, lmbd=0.1,
                 lr=1e-4, lr_stepsize=1, lr_gamma=0.97, m_in=0, m_out=-10, steps=60, step_size_decay=1.0, num_epochs=5, **MODEL_args):
        super().__init__()
...
def run_ood_analysis(args, ckpt_path: Union[str, Path]):
    ...
    plt.legend()
    save_path = '/home/cip/ai2022/qi27ycyt/adl23/ex_03/plots/histogram.png'
...
if __name__ == '__main__':
    ...
    # 2) Evaluate model
    ckpt_path: str = "/home/cip/ai2022/qi27ycyt/adl23/ex_03/models"
